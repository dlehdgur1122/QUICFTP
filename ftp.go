...
func (c *ServerConn) openDataConn() (quic.Stream/*net.Conn*/, error) {
    ...
    */
	if c.options.tlsConfig != nil {
		...
		c.options.quicConn , err = quic.DialAddr(addr, c.options.tlsConfig, nil)
		if err != nil {
		    return nil, err
		}
		c.options.quicStream , err = c.options.quicConn.OpenStreamSync(context.Background())
		if err != nil {
            return nil, err
        }
		return c.options.quicStream, err
	}
...
func (c *ServerConn) cmdDataConnFrom(offset uint64, format string, args ...interface{}) (quic.Stream/*net.Conn*/, error) {
...
func (r *Response) Close() error {
	...
	err := r.c.options.quicConn.Close()
